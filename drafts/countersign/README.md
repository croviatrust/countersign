...
```bash
cargo install countersign          # or: pip install countersign
countersign witness --digest sha256:… --log https://witness.croviatrust.com
countersign verify proof.json --pubkey witness.pub
```
