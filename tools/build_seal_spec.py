...
npm install @crovia/seal       # npm, ESM, provenance attested</pre></div>
    ...
    <div class="sp-card"><div class="k">Companions</div><h3>Threat model, log, trust root</h3><p><a href="/registry/seal/threat-model/">Threat model</a> · <a href="/registry/seal/log/">Transparency log</a> · <a href="/trust-root.json">Issuer trust root</a> · <a href="/registry/seal/">Seal overview</a> · <a href="/registry/tacet/spec/">TACET, the first protocol that wraps Seals</a></p></div>
  </div>
